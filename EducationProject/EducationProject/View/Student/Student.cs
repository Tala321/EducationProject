...
namespace EducationProject.View.Student
{
    public partial class Student : Form
    {
        ...
        private void personalInfoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            lblCurrrentStudentPhoto.Left = 337;
        ...
        {
            EditInfo EditStudentInfo = new EditInfo();
        ...
        {
            MessageToGroupmate messageToGroupmate = new MessageToGroupmate();
